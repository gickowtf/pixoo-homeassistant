...
| time_end          | -optional     use {{ template }}  | time string example: {{ as_timestamp(state_attr('timer.tea', 'finishes_at'))\|timestamp_custom("%H:%M") }} #default None                                                                                                                                                             |
| time_end_color          | -optional     use "[R, G, B]" or [Colors](#colors)  | RGB Color #default light_grey                                                                                                                                                             |
